...
import sample.animations.AnimationFX;
 ...
 */
public class MyForwardFlip extends AnimationFX {
     ...
     */
    public MyForwardFlip(Node node) {
        super(node);
    }

    public MyForwardFlip() {
    }
    ...
    void initTimeline() {
        ...
        setTimeline(new Timeline(
                new KeyFrame(Duration.millis(0),
                        new KeyValue(getNode().rotateProperty(), 180, Interpolator.EASE_OUT)
                ),
                new KeyFrame(Duration.millis(400),
                        new KeyValue(getNode().rotateProperty(), 95, Interpolator.EASE_OUT),
                        new KeyValue(getNode().translateZProperty(), -75, Interpolator.EASE_OUT)
                ),
                new KeyFrame(Duration.millis(500),
                        new KeyValue(getNode().rotateProperty(), 80, Interpolator.EASE_IN),
                        new KeyValue(getNode().translateZProperty(), -75, Interpolator.EASE_IN)
                ),
