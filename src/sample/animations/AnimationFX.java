...
public abstract class AnimationFX {
    ...
    private Node node;
    private animatefx.animation.AnimationFX nextAnimation;
     ...
     * @return
     */
    private sample.animations.AnimationFX onFinished() {
        if (reset) {
            resetNode();
        }
     ...
     * @return
     */
    public sample.animations.AnimationFX playOnFinished(animatefx.animation.AnimationFX animation) {
     ...
     * @return
     */
    public sample.animations.AnimationFX setResetOnFinished(boolean reset) {
        this.reset = reset;
        return this;
    }
     ...
     * @return
     */
    public sample.animations.AnimationFX stop() {
        timeline.stop();
        return this;
    }
    ...
    public animatefx.animation.AnimationFX getNextAnimation() {
        return nextAnimation;
    }

    protected void setNextAnimation(animatefx.animation.AnimationFX nextAnimation) {
