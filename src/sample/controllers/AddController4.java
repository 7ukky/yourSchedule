...
public class AddController4 {
    ...
    void initialize() {
        ...
        NextButton.setOnAction(event -> {
            ...
            if (date == null) Handler.AddSubject(subject);
            else Handler.AddSubject(subject, date);
        ...
        RadioButton.setOnAction(event -> {
            if(RadioButton.isSelected()) datePicker.setVisible(true);
